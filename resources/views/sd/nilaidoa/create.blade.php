...
@section('title', 'Tambah Nilai Hafalan Doa')

@section('content')
<div class="container">
    <h2 class="mb-4">Tambah Nilai Hafalan Doa</h2>

    <div class="card shadow">
        <div class="card-body">
            <form action="{{ route('sd.nilaidoa.store') }}" method="POST">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <a href="{{ route('sd.nilaidoa.index') }}" class="btn btn-secondary">Batal</a>
            </form>
        </div>
    </div>
</div>
