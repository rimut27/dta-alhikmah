...
@section('content')
<div class="container">
    <h2 class="mb-4">Tambah Nilai Hafalan Surah MDAUD </h2>

    <div class="card shadow">

        <div class="card-body">
            <form action="{{ route('tk.nilaihafalansurah.store') }}" method="POST">
                @csrf
                <div class="mb-3">
                ...
                <a href="{{ route('tk.nilaihafalansurah.index') }}" class="btn btn-secondary">Batal</a>
            </form>
        </div>
    </div>
</div>
